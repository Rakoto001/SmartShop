$(document).ready(function(){
    ...
    if($('#article-list-datatable').length > 0){
        var articleTableElement = '#article-list-datatable' 
        var $dataTable = $(articleTableElement)
        $dataTable.dataTable({
            "pageLength": 10,
           ...
           ajax:{
               ...
               "data" : function( data ){
                   ...
                   data.lisType = $('#article-list-datatable').val();
                   columnList = new Array(),
                
                $(articleTableElement+ 'thead th tr').each(function(){
