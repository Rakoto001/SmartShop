 ...
 */
final class Version20210729154557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD comment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comments ADD CONSTRAINT FK_5F9E962AF8697D13 FOREIGN KEY (comment_id) REFERENCES articles (id)');
